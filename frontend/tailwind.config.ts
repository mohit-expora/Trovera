...
const config: Config = {
  ...
  content: [
    ...
    "./node_modules/@trovera/ui/dist/**/*.{js,cjs,mjs}",
  ],
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      colors: {
        ...
        trovera: {
          ...
          "purple-dark": "hsl(270, 30%, 55%)",
          blue: "hsl(220, 60%, 75%)",
          "blue-dark": "hsl(220, 30%, 45%)",
          pink: "hsl(340, 60%, 78%)",
          "pink-dark": "hsl(340, 30%, 52%)",
          green: "hsl(145, 45%, 68%)",
          "green-dark": "hsl(145, 25%, 42%)",
          amber: "hsl(45, 80%, 75%)",
          "amber-dark": "hsl(45, 40%, 48%)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
